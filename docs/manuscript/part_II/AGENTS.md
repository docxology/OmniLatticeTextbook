...
- **Citations** use `[@key]` and MUST resolve in [`../references.bib`](../../../docs/manuscript/references.bib).
...
- **Glossary links** use `[**term**](#gl:<anchor>)` against the anchors defined in
  [`../glossary.md`](../../../docs/manuscript/glossary.md): `system`, `model`, `parameter`, `variable`,
...
- Add or reorder chapters by editing [`../config.yaml`](../../../docs/manuscript/config.yaml), then run
