...
The master glossary [`../glossary.md`](../../../docs/manuscript/glossary.md) is also included as a
reference appendix (Appendix D).

## Ordering is data-driven

The order and display titles come from the single source of truth,
[`../config.yaml`](../../../docs/manuscript/config.yaml), under `appendices.reference`. The current
sequence is:
...
See the sibling READMEs for the [labs convention](../../../docs/manuscript/labs/README.md) and the
[question-bank convention](../../../docs/manuscript/questions/README.md).
