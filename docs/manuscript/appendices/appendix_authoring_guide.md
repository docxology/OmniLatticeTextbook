...
The book is **data-driven from [`config.yaml`](../../../docs/manuscript/config.yaml)**. The list of
...
Open [`config.yaml`](../../../docs/manuscript/config.yaml). To add or rename a chapter, edit the
...
2. the matching entry in [`glossary.md`](../../../docs/manuscript/glossary.md)
...
Citations are `[@key]` and must resolve in [`references.bib`](../../../docs/manuscript/references.bib).
