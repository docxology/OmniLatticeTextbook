...
This part is **data-driven from [`../config.yaml`](../../../docs/manuscript/config.yaml)**. Its title,
...
|---|---------|-------------------------------------|-----|-----------|
| 1 | [Orientation to the Field](orientation.md) | Stub: situates the subject — scope, key questions, the map of the rest of the book, and why the field matters. | [Lab](../../../docs/manuscript/labs/part_0/lab_orientation.md) | [Bank](../../../docs/manuscript/questions/part_0/q_orientation.md) |
| 2 | [Core Methods and Tools](core_methods.md) | Stub: the working toolkit — methods, conventions, software, and reproducible-workflow habits the book relies on. | [Lab](../../../docs/manuscript/labs/part_0/lab_core_methods.md) | [Bank](../../../docs/manuscript/questions/part_0/q_core_methods.md) |
| 3 | [Quantitative Foundations](quantitative_foundations.md) | Stub: units and dimensions, order-of-magnitude estimation, simple models, and the descriptive statistics later chapters assume. | [Lab](../../../docs/manuscript/labs/part_0/lab_quantitative_foundations.md) | [Bank](../../../docs/manuscript/questions/part_0/q_quantitative_foundations.md) |
...
[Authoring Guide](../../../docs/manuscript/appendices/appendix_authoring_guide.md), and the
[Master Glossary](../../../docs/manuscript/glossary.md).
