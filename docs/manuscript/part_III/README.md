...
> [`../config.yaml`](../../../docs/manuscript/config.yaml). The prose, objectives, figures, and
> citations are placeholders marked with `<!-- STUB -->`, `TODO:`, or `TKTK`.
> Your job as author is to replace them. Start with the
> [Authoring Guide](../../../docs/manuscript/appendices/appendix_authoring_guide.md), keep the per-chapter
...
| - | ------- | ---------- | ------- | --- | ------------- |
| 10 | Applied Models | Put the formalisms to work: parameterise, fit, and interpret models on real problems. | [applied_models.md](applied_models.md) | [lab_applied_models.md](../../../docs/manuscript/labs/part_III/lab_applied_models.md) | [q_applied_models.md](../../../docs/manuscript/questions/part_III/q_applied_models.md) |
| 11 | Case Studies | End-to-end worked examples that carry a problem from data to defended conclusion. | [case_studies.md](case_studies.md) | [lab_case_studies.md](../../../docs/manuscript/labs/part_III/lab_case_studies.md) | [q_case_studies.md](../../../docs/manuscript/questions/part_III/q_case_studies.md) |
| 12 | Frontiers and Open Problems | Survey the unsettled edge: what is unknown, why it is hard, and where to push next. | [frontiers.md](frontiers.md) | [lab_frontiers.md](../../../docs/manuscript/labs/part_III/lab_frontiers.md) | [q_frontiers.md](../../../docs/manuscript/questions/part_III/q_frontiers.md) |
...
See also: [`../README.md`](../../../docs/manuscript/README.md) (book-level overview) and the other
parts — [Part 0](../../../docs/manuscript/part_0/README.md), [Part I](../../../docs/manuscript/part_I/README.md),
[Part II](../../../docs/manuscript/part_II/README.md).
