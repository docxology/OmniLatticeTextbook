...
[`../config.yaml`](../../../docs/manuscript/config.yaml) and enforced by
...
For the full how-to, see the [Authoring Guide](../../../docs/manuscript/appendices/appendix_authoring_guide.md)
