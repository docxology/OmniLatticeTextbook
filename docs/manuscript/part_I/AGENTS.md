...
truth for the part and its chapter list is [`../config.yaml`](../../../docs/manuscript/config.yaml)
...
[Authoring Guide](../../../docs/manuscript/appendices/appendix_authoring_guide.md) is the long-form companion.
...
- **Citations** are `[@key]` and every key must resolve in
  [`../references.bib`](../../../docs/manuscript/references.bib) (e.g. `smith2020foundations`,
