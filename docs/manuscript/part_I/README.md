...
[`../config.yaml`](../../../docs/manuscript/config.yaml) (`units:` → `part_I`). This README is a
...
[Authoring Guide appendix](../../../docs/manuscript/appendices/appendix_authoring_guide.md) for the fill workflow.

| # | Chapter | Stub description | Chapter | Lab | Questions |
|---|---------|------------------|---------|-----|-----------|
| 1 | **First Principles** | The starting axioms and definitions of the field; what is assumed, what is derived, and why. | [`first_principles.md`](first_principles.md) | [lab](../../../docs/manuscript/labs/part_I/lab_first_principles.md) | [bank](../../../docs/manuscript/questions/part_I/q_first_principles.md) |
| 2 | **Building Blocks** | The smallest reusable units — the components every later model is assembled from. | [`building_blocks.md`](building_blocks.md) | [lab](../../../docs/manuscript/labs/part_I/lab_building_blocks.md) | [bank](../../../docs/manuscript/questions/part_I/q_building_blocks.md) |
| 3 | **Structure and Form** | How building blocks compose into larger structures, and the patterns that recur across scales. | [`structure_and_form.md`](structure_and_form.md) | [lab](../../../docs/manuscript/labs/part_I/lab_structure_and_form.md) | [bank](../../../docs/manuscript/questions/part_I/q_structure_and_form.md) |
...
1. **Change the structure** in [`../config.yaml`](../../../docs/manuscript/config.yaml) — add, reorder,
...
3. **Fill the prose**, replacing every stub marker; keep all cross-references,
   citations (`[@key]` resolving in [`../references.bib`](../../../docs/manuscript/references.bib)), and
